...
<body>
     ...
     <div class="mySlides fade">
       ...
       <img src="{{ asset('images/wallpaper44.jpg')}}" style="width:100%">
       <div class="text">Ankara Top</div>
     </div>

     <div class="mySlides fade">
       <div class="numbertext"></div>
       <img src="{{ asset('images/wallpaper22.jpg')}}" style="width:100%">
       <div class="text">Ankara Top</div>
     </div>

     <div class="mySlides fade">
       <div class="numbertext"></div>
       <img src="{{ asset('images/wallpaper1.jpg')}}" style="width:100%">
       <div class="text">Ankara Gown</div>
     </div>
