...
<div class="row">
 <div class="col-md-8">
     <div class="card">
         ...
         <div class="card-body">
             <img src="/tailoring/storage/app/public/images/{{$product->image}}" width="70%" alt="">
             <hr>
             <p>
             ...
             <hr>
             <p>
                 <b>Contact info: </b> {{$product->phone_no}}
              </p>
         </div>

         <div class="card-footer">
             <button class="btn btn-outline-secondary" @click="showForm">Take Measurement</button>
         </div>
     </div>
<br>
     <div class="card" v-if="click">
         <div class="card-header">
             <h2 style="color: darkturquoise;">Take Your Measurement Here...</h2>
         </div>
         ...
         <div class="card-body">
            <form action="{{ url('/pages/measurements') }}" method="POST">
                ...
                <div class="row">
                  ...
                  <input type="hidden" value="{{$product->product_name}}" name="product_name" required>
                  <button type="submit" class="btn btn-outline-primary">Send</button>
                  <button class="btn btn-outline-dark" @click="closeForm">Cancel</button>
            </form>
         </div>
     </div>
 ...
 <div class="col-md-4">
     <div class="card">
         <div class="card-header">
             <h3 style="color: darkturquoise;">Latest Products</h3>
         </div>
...
<br />
     <div class="card">
         <div class="card-header">
             <h3 style="color: darkturquoise;">Products Category</h3>
         </div>

         <div class="card-body">
             @foreach($categories as $category)
                 <p>
                     <a href="{{ url('/pages/product', $category->id) }}">
                         {{$category->name}}
                     </a>
                 </p><hr>
             @endforeach
