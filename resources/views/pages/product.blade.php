 ...
 <div class="row">
   ...
   <div class="column">
     ...
     <a href="{{ url('/single', $product->id) }}">
       ...
       <img src="/tailoring/storage/app/public/images/{{$product->image}}" alt="Jackets" style="width:90%">
     </a>
 <hr>
     <div class="card" style="text-align: center">
         <a href="{{ url('/single', $product->id) }}" class="btn btn-outline-primary" >View Details</a>
     </div>
   ...
   @endforeach
 {{--
   <p>Long jackets: with our  material 4000,without our material 2500 <br>
   mid-length jacket: with our material 3500,without our material 2000 <br>
 short jackets: with our material 3500,without our material 2500 </p>  --}}
 <!-- END GRID -->
 </div>
